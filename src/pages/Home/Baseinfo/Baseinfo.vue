<template>
  <div>
    ...
    >
      <!-- 基本信息 -->
      <van-tab title="基本">
        <van-tabs v-model="myText" color="#3270e1" sticky>
        ...
        <van-collapse v-model="recorderName">
          ...
          >
            <ul>
              <li class="item-record">
                所属部门
                <span>{{equipment.office.officeName}}</span>
              </li>
              <li class="item-record">
                装备种类
              ...
              <li class="item-record" style="border:none">
                装备状态
